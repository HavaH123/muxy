...
class Muxy < Formula
  ...
  if Hardware.is_64_bit?
    url "https://github.com/havah123/muxy/releases/download/v#{version}/darwin_amd64.zip"
    sha256 '6d4aa05dfd0d94c98e93b6306bf660228e7254108c9f970e84932be8087d93b5'
  else
    url "https://github.com/havah123/muxy/releases/download/v#{version}/darwin_386.zip"
